...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMPPackage_Statics::NewProp_actors_Inner = { "actors", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FMPActor, METADATA_PARAMS(0, nullptr) }; // 1290168997
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMPPackage_Statics::NewProp_actors = { "actors", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMPPackage, actors), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_actors_MetaData), NewProp_actors_MetaData) }; // 1290168997
...
struct Z_CompiledInDeferFile_FID_VGS_Development_Unreal_Projects_VirtuosoWorlds_Plugins_VW_Creators_Plugin_Source_VW_Creators_Plugin_Public_Model_Package_MPPackage_h__Script_VW_Creators_Plugin_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMPPackage::StaticStruct, Z_Construct_UScriptStruct_FMPPackage_Statics::NewStructOps, TEXT("MPPackage"),&Z_Registration_Info_UScriptStruct_FMPPackage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMPPackage), 4125606733U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VGS_Development_Unreal_Projects_VirtuosoWorlds_Plugins_VW_Creators_Plugin_Source_VW_Creators_Plugin_Public_Model_Package_MPPackage_h__Script_VW_Creators_Plugin_1749273672{
