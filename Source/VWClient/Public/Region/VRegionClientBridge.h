...
/**
 * Region bridge used by AVRegionClient to issue spatial/material/collision requests through the owning controller.
 *
...
public:
	...
	void RequestCollisionsBatch(const TArray<FGuid>& CollisionIds) const;
